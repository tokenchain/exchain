...
replace (
	github.com/cosmos/cosmos-sdk => github.com/okex/cosmos-sdk v0.39.3-0.20210409143616-26d5ab6552de
	github.com/tendermint/iavl => github.com/okex/iavl v0.14.2-0.20210408064714-a6d01e85f799
