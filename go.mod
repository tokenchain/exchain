...
replace (
	github.com/cosmos/cosmos-sdk => github.com/okex/cosmos-sdk v0.39.3-0.20210408045947-9cc989913e15
	github.com/tendermint/iavl => github.com/okex/iavl v0.14.2-0.20210408045903-90451cab225a
