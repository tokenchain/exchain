...
replace (
	github.com/cosmos/cosmos-sdk => github.com/okex/cosmos-sdk v0.39.3-0.20210407112226-7ce6f54848fa
	github.com/tendermint/iavl => github.com/okex/iavl v0.14.2-0.20210407112344-ddab3d435d04
